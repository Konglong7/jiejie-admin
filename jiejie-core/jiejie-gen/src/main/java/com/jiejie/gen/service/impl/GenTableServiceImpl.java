package com.jiejie.gen.service.impl;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.jiejie.system.entity.SysMenu;
import com.jiejie.gen.entity.*;
import com.jiejie.gen.mapper.GenTableColumnMapper;
import com.jiejie.gen.mapper.GenTableMapper;
import com.jiejie.system.mapper.SysMenuMapper;
import com.jiejie.system.entity.SysRole;
import com.jiejie.system.entity.SysRoleMenu;
import com.jiejie.system.mapper.SysRoleMapper;
import com.jiejie.system.mapper.SysRoleMenuMapper;
import com.jiejie.gen.service.GenTableService;
...
public class GenTableServiceImpl implements GenTableService {
    ...
    public void importTable(String[] tableNames) {
        for (String tableName : tableNames) {
            ...
            table.setPackageName("com.jiejie.biz");
    ...
    public List<String> previewGenerateFiles(Long tableId) {
        ...
        if (projectRoot.endsWith("jiejie-web")) {
    ...
    public List<String> generateToProject(Long tableId) {
        ...
        // 获取项目根目录
        String projectRoot = System.getProperty("user.dir");
        // 如果是在 jiejie-web 目录下运行，需要找到项目根目录
        if (projectRoot.endsWith("jiejie-web")) {
            projectRoot = projectRoot.substring(0, projectRoot.length() - 8);
        }
    ...
    private String getProjectFilePath(GenTable table, String fileName, String projectRoot) {
        ...
        return switch (fileName) {
            case "Entity.java" -> projectRoot + "/jiejie-core/jiejie-biz/src/main/java/com/jiejie/biz/entity/" + className + ".java";
            case "Mapper.java" -> projectRoot + "/jiejie-core/jiejie-biz/src/main/java/com/jiejie/biz/mapper/" + className + "Mapper.java";
            case "Service.java" -> projectRoot + "/jiejie-core/jiejie-biz/src/main/java/com/jiejie/biz/service/" + className + "Service.java";
            case "ServiceImpl.java" -> projectRoot + "/jiejie-core/jiejie-biz/src/main/java/com/jiejie/biz/service/impl/" + className + "ServiceImpl.java";
            case "Controller.java" -> projectRoot + "/jiejie-core/jiejie-biz/src/main/java/com/jiejie/biz/controller/" + className + "Controller.java";
            case "api.ts" -> projectRoot + "/jiejie-ui/src/api/" + businessName + ".ts";
            case "index.vue" -> projectRoot + "/jiejie-ui/src/views/" + moduleName + "/" + businessName + "/index.vue";
