package com.jiejie.system.helper;
...
public class SystemConfigHelper implements com.jiejie.crypto.CryptoConfigProvider, com.jiejie.mail.MailConfigProvider {
    ...
    public String getSiteName() {
        return getString(GROUP_SYSTEM, "siteName", "Jiejie管理系统");
    }
